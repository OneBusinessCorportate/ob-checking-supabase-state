...
export async function GET(request: NextRequest) {
  try {
    ...
    let q = supabase
      .from('v_armsoft_issued_invoices')
      .select('id, company_id, doc_date, doc_num, doc_type_name, curr_code, summ, part_name, part_tax_code, tax_invoice_serial_and_number, doc_state_name, creator')
